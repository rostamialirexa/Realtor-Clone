  ...
  return (
    <main>
      ...
      onClick={()=>{
       ...
       className="fixed top-[8%] right-[5%] z-10 bg-white cursor-pointer border-2 border-gray-400 rounded-full w-12 h-12 flex justify-center items-center">
              <FaShare  className="text-lg text-slate-500 "/>
      </div>
      {shareLinkedCopied && (
        <p className="fixed top-[13%] right-[7%] z-10 font-semibold border-2 border-gray-400 rounded-md bg-white p-2">Link Copied</p>
      )}
      <div className="mt-4 mb-4 flex flex-col md:flex-row container lg:mx-auto p-4 rounded-lg  shadow-lg bg-white lg:space-x-5 ">
        <div className=" w-full  ">
            ...
            <div className="mt-6">
                  <button onClick={()=>setContactLandlord(true)} className="px-7 py-3 bg-blue-600 text-white font-medium uppercase  text-sm rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg w-full text-center transition duration-150 ease-in-out">Contact Landlord</button>
            </div>
                )
            }
            {contactLandlord && (
